    	...
    	<div class="container">
    		...
    		<div class="box">
    			<form action="" method="POST">
                    ...
                    <input type="text" name="alamat" placeholder="Alamat" class="input-control" value="<?php echo $d->admin_addess ?>" required>
                    <input type="submit" name="submit" value="Ubah Profiles" class="btn">
                </form>
                 <?php
